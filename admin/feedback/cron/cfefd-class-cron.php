...
if (!class_exists('cfefd_cronjob')) {
    class cfefd_cronjob
    {
        ...
        public function __construct()
        {
            ...
            add_filter('cron_schedules', array($this, 'cfefd_cron_schedules'));
            add_action('cfefd_extra_data_update', array($this, 'cfefd_cron_extra_data_autoupdater'));
        }
        ...
        public function cfefd_cron_schedules($schedules)
        {
            ...
            if (!isset($schedules['every_30_days'])) {
                ...
                $schedules['every_30_days'] = array(
                    ...
                    'display'  => __('Once every 30 days', 'contact-form-extender-for-divi-builder'),
                );
            }
         ...
         */ 
         ...
         static public function cfefd_send_data() {
 
                 $feedback_url = CFEFD_FEEDBACK_URL.'wp-json/coolplugins-feedback/v1/site';
                 ...
                 $extra_data_details = static::cpfm_get_user_info();
                  ...
                  $initial_version = get_option('cfefd_initial_version');
                  $initial_version = is_string($initial_version) ? sanitize_text_field($initial_version) : 'N/A';
                  $plugin_version = defined('CFEFD_PLUGIN_VERSION') ? CFEFD_PLUGIN_VERSION : 'N/A';
