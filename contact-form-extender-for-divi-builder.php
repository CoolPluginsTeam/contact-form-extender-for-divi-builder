...
define( 'CFEFD_PLUGIN_VERSION', '1.0.7' );
...
if(!class_exists('CFEFD_Main')) { 
    class CFEFD_Main {
        ...
        public static function cfefd_activate_plugin() {
			...
			if ( ! get_option( 'cfefd_file_upload_token_secret' ) ) {
				add_option( 'cfefd_file_upload_token_secret', wp_generate_password( 64, true, true ), '', 'no' );
			}
